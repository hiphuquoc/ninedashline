...
return [
    ...
    'images_base' => env('LANDING_IMAGES_BASE', rtrim(env('APP_URL', 'https://ninedashline.dev'), '/') . '/storage/images'),
    'logo_file' => 'logo-ninedashline.png',
    'favicon_file' => 'favicon-ninedashline.png',
    'hero_bg' => 'background-slider-ban-do-duong-luoi-bo.png',
